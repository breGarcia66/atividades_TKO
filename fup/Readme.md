...
### Missão: Repetição 1<!-- +for:1 -->[](#missão-seleção-1)
...
- [ ] `@loop_v     *2 :leet`[Loop com continue e break](https://github.com/qxcodefup/arcade/blob/master/base/loop_v/Readme.md)
- [ ] `@pares      *2 :leet`[Calculando soma](https://github.com/qxcodefup/arcade/blob/master/base/pares/Readme.md)
- [ ] `@sapatos    *2 :leet`[Sapatos para 2 e 3](https://github.com/qxcodefup/arcade/blob/master/base/sapatos/Readme.md)
- [ ] `@filhos     *2 :leet`[Filhos de Seu David](https://github.com/qxcodefup/arcade/blob/master/base/filhos/Readme.md)
- [ ] `@ceu        *2 :leet`[Ingrid quer chegar no céu](https://github.com/qxcodefup/arcade/blob/master/base/ceu/Readme.md)  
- [ ] `@esconde    *2 :leet`[Diana no esconde-esconde](https://github.com/qxcodefup/arcade/blob/master/base/esconde/Readme.md)

### Missão: Repetição 2<!-- +for:1 -->[](#missão-repetição-1)
...
### Missão: Vetores 1<!-- +list:1 -->[](#missão-repetição-1)
...
### Missão: Vetores 2<!-- +list:1 -->[](#missão-vetores-1)
...
- [ ] `@baruel      *04 :leet`[Figurinhas repetidas](https://github.com/qxcodefup/arcade/blob/master/base/baruel/Readme.md)
- [ ] `@tazos       *04 :leet`[Qual o mais repetido](https://github.com/qxcodefup/arcade/blob/master/base/tazos/Readme.md)
- [ ] `@josephus    *06 :leet`[Cabeças vão rolar](https://github.com/qxcodefup/arcade/blob/master/base/josephus/Readme.md)
...
### Missão: Strings 2<!-- +string:1 -->[](#missão-strings-1)
...
### Missão: Matrizes<!-- +mat:2 -->[](#missão-vetores-1)
...
### Missão: Structs<!-- +struct:4 -->[](#missão-vetores-1)

- [ ] `@fatores_type  +3 :leet`[Fatoração de um número](https://github.com/qxcodefup/arcade/blob/master/base/fatores/Readme.md)
- [ ] `@pedra_type    *4 :leet`[Pedra na lua](https://github.com/qxcodefup/arcade/blob/master/base/pedra/Readme.md)
...
### Missão: Dicionários<!-- +dict:3 -->[](#missão-vetores-1)

- [ ] `@tazos_dict      *6 :leet`[Qual o mais repetido](https://github.com/qxcodefup/arcade/blob/master/base/tazos/Readme.md)
- [ ] `@casais_dict     *4 :leet`[Quantos casais na arca](https://github.com/qxcodefup/arcade/blob/master/base/casais/Readme.md)
- [ ] `@exemplares_dict *4 :leet`[Arca quantos exemplares](https://github.com/qxcodefup/arcade/blob/master/base/exemplares/Readme.md)
- [ ] `@sopa_dict       *4 :open`[Sopa de coelho](https://github.com/qxcodefup/arcade/blob/master/base/sopa/Readme.md)
- [ ] `@fatores_dict    +3 :leet`[Fatoração de um número](https://github.com/qxcodefup/arcade/blob/master/base/fatores/Readme.md)

### Missão: Recursão<!-- +rec:2 -->[](#missão-vetores-1)

- [ ] `@primo_rec   *3 :leet`[Calculando se é](https://github.com/qxcodefup/arcade/blob/master/base/primo/Readme.md)
- [ ] `@sopa_rec    *4 :open`[Sopa de coelho](https://github.com/qxcodefup/arcade/blob/master/base/sopa/Readme.md)
- [ ] `@spok_rec    *3 :leet`[Número palíndromo](https://github.com/qxcodefup/arcade/blob/master/base/spok/Readme.md)
...
### Problemas: Seleção<!-- +if_else:1 -->[](#missão-seleção-2)
...
### Problemas: Repetição<!-- +for:1 -->[](#missão-repetição-2)
...
### Problemas: Vetores 2<!-- +list:1 -->[](#missão-vetores-2)
...
### Problemas: Strings 1<!-- +string:1 -->[](#missão-strings-1)
...
### Problemas: Strings 2<!-- +string:1 -->[](#missão-strings-1)
...
### Problemas: Matrizes<!-- +mat:1 -->[](#missão-matrizes)
...
### Problemas: Recursão<!-- +rec:1 -->[](#problemas-vetores-1)

- [ ] `@hanoi       +4 :leet` [Torres de Hanoi](https://github.com/qxcodefup/arcade/blob/master/base/hanoi/Readme.md)
- [ ] `@fatores_rec +2 :leet`[Fatoração de um número](https://github.com/qxcodefup/arcade/blob/master/base/fatores/Readme.md)

## Projetos<!-- main -->

### Jogos em modo texto<!-- +games:3 -->
...
- [ ] `@pr_game21   +4  :open` [Blackjack 21](https://github.com/qxcodefup/arcade/blob/master/base/pr_game21/Readme.md)
- [ ] `@pr_forca    +4  :open` [Jogo da Palavra Oculta](https://github.com/qxcodefup/arcade/blob/master/base/pr_forca/Readme.md)
- [ ] `@pr_bingo    +4  :open` [Simulador de Bingo e Gerador de Cartelas](https://github.com/qxcodefup/arcade/blob/master/base/pr_bingo/Readme.md)
- [ ] `@pr_orc      +4  :open` [Batalha Orc](https://github.com/qxcodefup/arcade/blob/master/base/pr_orc/Readme.md)
- [ ] `@pr_playfair +4  :open` [A cifra de Playfair](https://github.com/qxcodefup/arcade/blob/master/base/pr_playfair/Readme.md)
